...
outkeys = ['name', 'num_tracks', 'file', 'pid', 'modified_at', 'collaborative', 'num_albums', 'num_followers']

def get_playlist_info(cur_file, playlist):
    ...
    return {'name': cur_name, 'file': cur_file, 'pid': cur_pid, 'num_tracks': cur_tracks,
...
for i,mpdslice in enumerate(os.listdir(datadir)):
    ...
    with open(cpath, 'r') as f:
        ...
        for playlist in j['playlists']:
            ...
            cur_info = get_playlist_info(mpdslice,playlist)
