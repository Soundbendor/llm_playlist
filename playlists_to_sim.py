...
pls = UG.playlist_csv_generator('train_pids.csv', csv_path=res_dir)
...
idx_path = os.path.join(G.model_dir, 'retrain2_bm25_train_p.index')
pl_path = os.path.join(G.model_dir, 'retrain2_bm25_train_p.playlist')
